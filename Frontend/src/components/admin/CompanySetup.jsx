    ...
    return (
        <div className='min-h-screen bg-background text-foreground pb-12 transition-colors duration-200'>
            ...
            <div className='max-w-2xl mx-auto my-10 px-4'>
                <form onSubmit={submitHandler} className='bg-card border border-border text-card-foreground rounded-2xl p-8 shadow-sm'>
                    <div className='flex items-center gap-5 pb-6 border-b border-border mb-6'>
                        <Button 
                            type="button"
                            onClick={() => navigate("/admin/companies")} 
                            variant="outline" 
                            className="flex items-center gap-2 border-border text-foreground hover:bg-muted font-medium"
                        >
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                        ...
                        <div className='space-y-1.5 md:col-span-2'>
                            ...
                            <Input
                                ...
                                className='bg-background border-border text-foreground cursor-pointer text-xs'
                            />
                        </div>
                    </div>
                    {
                        loading ? (
                            <Button disabled className="w-full mt-8 bg-[#7209b7] text-white">
                                <Loader2 className='mr-2 h-4 w-4 animate-spin' /> Please wait
                            </Button>
                        ) : (
                            <Button type="submit" className="w-full mt-8 bg-[#7209b7] hover:bg-[#5f0799] text-white">
                                Update
                            </Button>
                        )
                    }
